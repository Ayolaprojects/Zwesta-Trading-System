"""
Stop bot → PATCH config to reset trade amount → Restart bot.
"""
...
def do(method, path, body=None, timeout=20):
...
# 2. PATCH config with safe trade amounts
...
adapt = cfg.get('tradeAmountAdaptation', {})
if adapt:
